...
def deserialize_message_recursive(msg: bytes, type_name: str) -> Any:
    try:
        return deserialize_message(msg, get_message(type_name))
...
def convert_msg(topic_name: str, msg: bytes, type_map: dict) -> bytes:
    ...
    old_msg = deserialize_message_recursive(msg, old_type)
